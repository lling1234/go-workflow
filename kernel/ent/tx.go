...
func (tx *Tx) init() {
	...
	tx.NodeDetails = NewNodeDetailsClient(tx.config)
	tx.Nodenotifiers = NewNodenotifiersClient(tx.config)
...
// applies a query, for example: Identitylink.QueryXXX(), the query will be executed
