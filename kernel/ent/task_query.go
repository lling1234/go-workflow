...
func (tq *TaskQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (tgb *TaskGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("ent: TaskGroupBy.Strings 返回结果集不唯一,数量%d", len(v))
	}
	return
}
...
func (tgb *TaskGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("ent: TaskGroupBy.Ints 返回结果集不唯一,数量%d", len(v))
	}
	return
}
...
// It is only allowed when executing a group-by query with one field.
func (tgb *TaskGroupBy) Uint64s(ctx context.Context) ([]uint64, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("ent: TaskGroupBy.Uint64s is not achievable when grouping more than 1 field")
	}
	var v []uint64
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TaskGroupBy) Uint64sX(ctx context.Context) []uint64 {
	v, err := tgb.Uint64s(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (tgb *TaskGroupBy) Uint64(ctx context.Context) (_ uint64, err error) {
	var v []uint64
	if v, err = tgb.Uint64s(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("ent: TaskGroupBy.Uint64s 返回结果集不唯一,数量%d", len(v))
	}
	return
}

// Uint64X is like Uint64, but panics if an error occurs.
func (tgb *TaskGroupBy) Uint64X(ctx context.Context) uint64 {
	v, err := tgb.Uint64(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (tgb *TaskGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("ent: TaskGroupBy.Float64s 返回结果集不唯一,数量%d", len(v))
	}
	return
}
...
func (tgb *TaskGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("ent: TaskGroupBy.Bools 返回结果集不唯一,数量%d", len(v))
	}
	return
}
...
func (ts *TaskSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("ent: TaskSelect.Strings 返回结果不唯一,数量 %d", len(v))
	}
	return
}
...
func (ts *TaskSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("ent: TaskSelect.Ints 返回结果不唯一,数量 %d", len(v))
	}
	return
}
...
func (ts *TaskSelect) Uint64s(ctx context.Context) ([]uint64, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("ent: TaskSelect.Uint64s is not achievable when selecting more than 1 field")
	}
	var v []uint64
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
// Uint64sX is like Uint64s, but panics if an error occurs.
func (ts *TaskSelect) Uint64sX(ctx context.Context) []uint64 {
	v, err := ts.Uint64s(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (ts *TaskSelect) Uint64(ctx context.Context) (_ uint64, err error) {
	var v []uint64
	if v, err = ts.Uint64s(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("ent: TaskSelect.Uint64s 返回结果不唯一,数量 %d", len(v))
	}
	return
}

// Uint64X is like Uint64, but panics if an error occurs.
func (ts *TaskSelect) Uint64X(ctx context.Context) uint64 {
	v, err := ts.Uint64(ctx)
	if err != nil {
		panic(err)
	}
...
func (ts *TaskSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("ent: TaskSelect.Float64s 返回结果不唯一,数量 %d", len(v))
	}
	return
}
...
func (ts *TaskSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("ent: TaskSelect.Bools 返回结果不唯一,数量 %d", len(v))
	}
	return
}
