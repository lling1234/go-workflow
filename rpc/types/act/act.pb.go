...
func (x *ProcDefIdReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProcDefIdReq) ProtoMessage() {}

func (x *ProcDefIdReq) ProtoReflect() protoreflect.Message {
	mi := &file_act_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProcDefIdReq.ProtoReflect.Descriptor instead.
func (*ProcDefIdReq) Descriptor() ([]byte, []int) {
	return file_act_proto_rawDescGZIP(), []int{2}
}

func (x *ProcDefIdReq) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
type TaskReq struct {
	...
	IsFinished    int32  `protobuf:"bytes,5,opt,name=isFinished,proto3" json:"isFinished,omitempty"`
	Step          int32  `protobuf:"varint,6,opt,name=step,proto3" json:"step,omitempty"`
	MemberCount   int32  `protobuf:"bytes,7,opt,name=memberCount,proto3" json:"memberCount,omitempty"`
	UnCompleteNum int32  `protobuf:"bytes,8,opt,name=unCompleteNum,proto3" json:"unCompleteNum,omitempty"`
...
var file_act_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x22, 0x1e, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x63,
	0x44, 0x65, 0x66, 0x49, 0x64, 0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xdb, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f,
	...
	0x66, 0x6f, 0x72, 0x6d, 0x49, 0x64, 0x32, 0xb8, 0x03, 0x0a, 0x03, 0x61, 0x63, 0x74, 0x12, 0x31,
	...
	0x65, 0x66, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x38, 0x0a, 0x10, 0x73, 0x65, 0x74, 0x50, 0x72,
	0x6f, 0x63, 0x44, 0x65, 0x66, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x12, 0x11, 0x2e, 0x61, 0x63,
	0x74, 0x2e, 0x50, 0x72, 0x6f, 0x63, 0x44, 0x65, 0x66, 0x49, 0x64, 0x52, 0x65, 0x71, 0x1a, 0x11,
	0x2e, 0x61, 0x63, 0x74, 0x2e, 0x50, 0x72, 0x6f, 0x63, 0x44, 0x65, 0x66, 0x52, 0x65, 0x70, 0x6c,
...
var file_act_proto_goTypes = []interface{}{
	...
	(*ProcDefIdReq)(nil),      // 2: act.ProcDefIdReq
...
var file_act_proto_depIdxs = []int32{
	...
	2,  // 7: act.act.setProcDefActive:input_type -> act.ProcDefIdReq
